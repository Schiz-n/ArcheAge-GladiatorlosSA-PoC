...
if __name__ == "__main__":
    file_to_watch = r"C:\Users\<Name>\Documents\ArcheRage\Combat.log"
    triggers = [
        ("was struck by a |cff25fcffCharmed|r debuff!", "charmed.mp3"),
        ("was struck by a |cff25fcffTripped|r debuff!", "tripped.mp3"),
        ("was struck by a |cff25fcffStun|r debuff!", "stunned.mp3")
    ]
